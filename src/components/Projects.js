...
<div id="projects" className="projects">
  ...
  <tr>
    <td className="projectstd"><img src="https://i.imgur.com/DD1JFFu.png" alt="Placeholder" width="250" className="imgborder"/>
    ...
    <td><img src="https://i.imgur.com/5fI5vry.jpg" alt="Placeholder" width="250" className="imgborder"/>
    <h4>Entolog</h4>
    ...
    <td><img src="https://i.imgur.com/p1ahl2N.png" alt="Placeholder" width="250" className="imgborder"/>
    <h4>Jobify</h4>
